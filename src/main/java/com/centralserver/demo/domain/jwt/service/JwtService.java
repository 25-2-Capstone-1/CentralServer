package com.centralserver.demo.domain.jwt.service;

import com.centralserver.demo.domain.jwt.dto.JWTResponseDTO;
import com.centralserver.demo.domain.jwt.dto.RefreshRequestDTO;
import com.centralserver.demo.domain.jwt.entity.RefreshEntity;
import com.centralserver.demo.domain.jwt.repository.RefreshRepository;
...
public class JwtService {
    ...
    public JWTResponseDTO cookie2Header(
        ...
        Boolean firstLogin = JWTUtil.getFirstLogin(refreshToken);

        // 토큰 생성
        String newAccessToken = JWTUtil.createJWT(userEmail, role, true, firstLogin);
        String newRefreshToken = JWTUtil.createJWT(userEmail, role, false, firstLogin);
